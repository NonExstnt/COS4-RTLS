...
def visualize_stations(df, station_info, workshop_name):
    ...
    for i, station in enumerate(station_info):
        ...
        circle = plt.Circle((station['center_x'], station['center_y']), 
                           station['radius'], 
        ...
        # Mark center
        ax.scatter(station['center_x'], station['center_y'], 
                  color='red', marker='x', s=200, linewidths=3, zorder=10)
        
        # Add label
        ax.text(station['center_x'], station['center_y'], 
    ...
    ax.set_title(f'{workshop_name} - Detected Stations (K-means)', 
